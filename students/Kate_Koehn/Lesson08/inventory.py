'''
To summarize: 1. You will create a program to initially create, and subsequently update, a CSV file that lists
which furniture is rented to which customer (to replace use of the spreadsheet mentioned above).
...
def test_add_susan():
    add_furniture("susans_stuff.csv", "Susan Wong", "GH9S", "Lamp", 200.00)
    add_furniture("susans_stuff.csv", "Susan Wong", "L4J9", "Table", 4000.00)
...
if __name__ == "__main__":
    ...
    susans_crap = single_customer("Susan Wong", "susans_stuff.csv")
    susans_crap("invoice_file.csv")