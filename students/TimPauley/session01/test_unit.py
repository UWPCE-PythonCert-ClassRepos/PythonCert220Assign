...
from inventory_management.inventoryClass import returnAsDictionary
...
class inventoryClass(TestCase): 

	def returnAsDictionary

class furnitureTest(TestCase):

	def add_new_item

class electricManagementTest(TestCase):
