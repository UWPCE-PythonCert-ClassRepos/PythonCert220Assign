...
def import_data(db, directory_name, products_file, customers_file, rentals_file):
    ...
    threads = [threading.Thread(target=_add_bulk_data, args=(results_dict, products, directory_name, products_file)),
               threading.Thread(target=_add_bulk_data, args=(results_dict, customers, directory_name, customers_file)),
               threading.Thread(target=_add_bulk_data, args=(results_dict, rentals, directory_name, rentals_file))]
